        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto col-12">
            ...
            <li class="nav-item dropdown no-arrow text-primary mx-1 d-flex align-items-center pointer col-md-10">
                ...
                <b>
                    Welcome to Aishwary Salon's Dashboard
                </b>
            </li>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="ce-example">
                              <div class="ce-example__header">
                                <a class="ce-example__header-logo" href=""></a>
                        ...
                        <form action="submitBlog.php" method="POST" id="myForm">

                              <input type="text" id="ftext" name="blog">
                      ...
                      <?php 
                            ...
                            ?>
                                  <script>
                                      ...
                                      var myBlogs = JSON.parse('<?php echo $blog; ?>');
                                      console.log(myBlog);
